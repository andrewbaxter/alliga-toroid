...
import com.zarbosoft.alligatoroid.compiler.model.error.DeserializePairTooManyValues;
import com.zarbosoft.alligatoroid.compiler.model.error.Error;
import com.zarbosoft.luxem.read.path.LuxemPathBuilder;
import com.zarbosoft.rendaw.common.Assertion;
import com.zarbosoft.rendaw.common.TSList;

public abstract class DefaultStateArrayBodyPair<C, T> implements BaseStateArrayBody<C, T> {
  private State key;
  ...
  private void push(
    ...
    if (!done) {
      ...
      errors.add(new DeserializePairTooManyValues(luxemPath.render()));
