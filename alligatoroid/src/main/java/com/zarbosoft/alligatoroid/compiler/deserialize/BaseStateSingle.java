...
public abstract class BaseStateSingle implements State {
  ...
  protected abstract BaseStateArray innerArrayBegin(TSList<Error> errors, LuxemPathBuilder luxemPath);
  ...
  protected abstract BaseStateRecord innerEatRecordBegin(TSList<Error> errors, LuxemPathBuilder luxemPath);
